...
router.get('/getHash', async (_req, res) => {
  try {
    ...
    const str = `2y8htx8218&100&Torder2&abcxyz&EN&00280104&cg02s2c7u4&https://dastakbackend.herokuapp.com/general/jazzCashCallback&PKR&${currentDate}&${expiryDate}&T${currentDate}&MPAY&1.1`;
